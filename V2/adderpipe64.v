module adder_pipe_64bit (
    ...
    reg [47:0] adda_s1;      // remaining bits of A
    reg [47:0] addb_s1;      // remaining bits of B
    reg        en_s1;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            sum_s2  <= {1'b0, adda_s1[15:0] + addb_s1[15:0] + sum_s1[16], sum_s1[15:0]};
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            sum_s3  <= {1'b0, adda_s2[15:0] + addb_s2[15:0] + sum_s2[32], sum_s2[31:0]};
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            sum_s4 <= {adda_s3[15:0] + addb_s3[15:0] + sum_s3[48], sum_s3[47:0]};
            en_s4  <= en_s3;
        end
    end
